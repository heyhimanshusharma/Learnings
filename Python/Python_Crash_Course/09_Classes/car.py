...
class Car:
    ...
    def get_descriptive_name(self):
        """Return a neat;y formatted name."""
    ...
    def update_odometer(self, mileage):
        ...
        reject the attempt if it attempts to roll the odometer back
        """
...
class ElectricCar(Car):
    ...
    def __init__(self, make, model, year):
        """"
        Initialize attributes to parent class.
        Then initialize attributes specific to eletric car.
        """
